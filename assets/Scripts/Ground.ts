...
export class Ground extends Component {
    ...
    // Vec3 is `Representation of 3D Vectors and Points`
    ...
    startUp() {
        // Get width of each ground node 
        this.groundWidth1 = this.ground1.getComponent(UITransform).width; // width: size of the UI node
    ...
    update(deltaTime: number) {
        ...
        // Get width of the current scene
